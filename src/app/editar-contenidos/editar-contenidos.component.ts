...
@Component({
  selector: 'app-editar-contenidos',
  standalone: true,
  imports: [
    CommonModule,
    MatDatepickerModule,
  ...
  templateUrl: './editar-contenidos.component.html',
  styleUrls: ['./editar-contenidos.component.scss']
})
export class EditarContenidosComponent implements OnInit {
