...
@Component({
  selector: 'app-anadir-contenidos',
  standalone: true,
  imports: [
    CommonModule,
    MatDatepickerModule,
  ...
  templateUrl: './anadir-contenidos.component.html',
  styleUrls: ['./anadir-contenidos.component.scss']
})
export class AnadirContenidosComponent {
